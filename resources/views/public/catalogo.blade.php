                ...
                <div id="toggle-filter" class="mt-3">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="mb-2">
                                <div class="input-group">
                                    <input type="number" id="priceMin" name="priceMin" class="form-control" placeholder="Mínimo" value="{{ request()->input('priceMin') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-2">
                                <label for="lugarRecogida" class="form-label">Recogida:</label>
                                <select name="lugarRecogida" id="lugarRecogida" class="form-select mb-3">
                                    <option value="Aeropuerto de El Prat de Llobregat" {{ request()->input('lugarRecogida') == 'Aeropuerto de El Prat de Llobregat' ? 'selected' : '' }}>Aeropuerto de El Prat de Llobregat</option>
                                    <option value="Aeropuerto de Girona" {{ request()->input('lugarRecogida') == 'Aeropuerto de Girona' ? 'selected' : '' }}>Aeropuerto de Girona</option>
                                    <option value="Aeropuerto de Reus" {{ request()->input('lugarRecogida') == 'Aeropuerto de Reus' ? 'selected' : '' }}>Aeropuerto de Reus</option>
                                </select>
                                ...
                                <select name="horaRecogida" class="form-select">
                                    ...
                                    <!-- Más opciones de hora de recogida -->
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="lugarEntrega" class="form-select mb-3">
                                    <option value="Aeropuerto de El Prat de Llobregat" {{ request()->input('lugarEntrega') == 'Aeropuerto de El Prat de Llobregat' ? 'selected' : '' }}>Aeropuerto de El Prat de Llobregat</option>
                                    <option value="Aeropuerto de Girona" {{ request()->input('lugarEntrega') == 'Aeropuerto de Girona' ? 'selected' : '' }}>Aeropuerto de Girona</option>
                                    <option value="Aeropuerto de Reus" {{ request()->input('lugarEntrega') == 'Aeropuerto de Reus' ? 'selected' : '' }}>Aeropuerto de Reus</option>
                                </select>
                                ...
                                <select name="horaEntrega" class="form-select">
                                    ...
                                    <!-- Más opciones de hora de entrega -->
                                </select>
                            </div>
                        </div>
                        @endcan
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 {{ $alquiler->disponible}}">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ $alquiler->marca }}</p>
                            <p class="card-text"><strong>Precio diario:</strong> {{ $alquiler->costoDiario }} €</p>
