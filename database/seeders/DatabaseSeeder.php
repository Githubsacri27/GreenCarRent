    ...
    public function run(): void
    {
        ...
        for ($i = 0; $i < 5; $i++) {
            DB::table('alquiler')->insert([
                ...
                'lugarEntrega' => 'Aeropuerto el Prat del Llobregat',
                'horaEntrega' => '08:30',
                'activo' => true,
            ]);
